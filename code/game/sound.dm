...
/proc/get_sfx(sound)
	if(istext(sound))
		switch(sound)
			...
			if("gun_m4a4")
				sound = pick('sound/weapons/gun_m4a4_1.ogg', 'sound/weapons/gun_m4a4_2.ogg', 'sound/weapons/gun_m4a4_3.ogg', 'sound/weapons/gun_m4a4_4.ogg', 'sound/weapons/gun_m4a4_5.ogg')
			//A:CM gun sounds
